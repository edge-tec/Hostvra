        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5 sm:gap-3 group">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[9px] sm:text-[10px] text-slate-500 font-semibold tracking-wider uppercase -mt-0.5">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="p-2 rounded-lg text-slate-700 hover:bg-slate-100 md:hidden flex items-center justify-center cursor-pointer ml-1"
          ...
          <div className="md:hidden border-t border-slate-200 bg-white/98 backdrop-blur-xl px-4 py-4 space-y-3 shadow-lg animate-in fade-in duration-200">
            <nav className="flex flex-col space-y-2 text-sm font-semibold text-slate-700">
              ...
              <Link
                href="/webmail"
                onClick={() => setMobileMenuOpen(false)}
                className="px-3 py-2 rounded-lg hover:bg-slate-100 transition flex items-center justify-between"
              >
            ...
            <div className="pt-2 border-t border-slate-100 flex flex-col gap-2">
              <Link
                href="/login"
                onClick={() => setMobileMenuOpen(false)}
                className="w-full py-2.5 rounded-xl border border-slate-200 text-center text-xs font-bold text-slate-700 hover:bg-slate-50"
              >
      ...
      <section className="relative pt-16 pb-20 md:pt-24 md:pb-28 bg-gradient-to-b from-white via-slate-50 to-slate-100/70 border-b border-slate-200/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-14 sm:mt-16 max-w-5xl mx-auto rounded-2xl bg-white border border-slate-200/90 shadow-2xl p-2 sm:p-4">
            <div className="flex items-center justify-between px-3 sm:px-4 py-3 border-b border-slate-200 bg-slate-100/80 rounded-t-xl gap-2">
              <div className="flex items-center gap-2 flex-shrink-0">
                <div className="w-3 h-3 rounded-full bg-rose-500" />
                <div className="w-3 h-3 rounded-full bg-amber-500" />
                <div className="w-3 h-3 rounded-full bg-emerald-500" />
                <span className="ml-2 text-xs font-mono text-slate-600 font-semibold hidden sm:inline">hostvra-control-plane:~/production</span>
              </div>
            ...
            <div className="p-4 sm:p-6 bg-slate-50/60 rounded-b-xl text-left">
              {activePreviewTab === 'vhosts' && (
